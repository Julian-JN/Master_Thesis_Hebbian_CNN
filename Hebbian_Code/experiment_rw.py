...
if __name__ == "__main__":
    ...
    rw_params = [
        {'params': model.conv1.parameters(), 'lr': 1},
        {'params': model.conv2.parameters(), 'lr': 1},
        {'params': model.conv3.parameters(), 'lr': 1}
    ]
    unsup_optimizer = optim.SGD(rw_params, lr=0)  # The lr here will be overridden by the individual lrs
